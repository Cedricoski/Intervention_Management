<div class="px-4 sm:px-6 lg:px-8">
    ...
    <div>
        @if ($editDatas)
        <livewire:edit-user :editDatas="$editDatas" />
        @endif
        <livewire:add-user />
    </div>
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            ...
                            <tr>
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                    @if (isAdmin())
                                    <button @click="open=!open;show=false{{ $editDatas?'$wire.resetEditDatas()':'' }}" wire:click="getDataForEdit({{$user->id}})" class=" hover:text-indigo-700 inline-block"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                                        </svg></button>
                                    <button @click="close=!close" wire:click="getDataForDelete({{$user->id}})" class=" hover:text-indigo-700 inline-block">
                    ...
                    <form wire:submit.prevent="delete({{ $deleteDatas->id }})">
                        ...
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">Voulez vous supprimer l'utilisateur?</p>
                                </div>
                            </div>
                        </div>
