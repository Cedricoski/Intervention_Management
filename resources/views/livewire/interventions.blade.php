...
<livewire:add-intervention-form/>
    ...
    <div class="mt-8 flow-root" x-data='{open:false}'>
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            ...
                            <tr>
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                    <button @click="open=true" wire:click="getDatas({{$intervention->id}})" class=" hover:text-indigo-700 inline-block">
                                    ...
                                    <a href="#" class=" hover:text-indigo-700 inline-block"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <div class="relative z-10" x-cloak @keydown.window.escape="open=false" x-show="open" x-init='$watch("open", o => !o && window.setTimeout(() => (open = false), 1000))' aria-labelledby="modal-title" role="dialog" aria-modal="true">
            ...
            <div class="fixed inset-0 z-10 overflow-y-auto">
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-6xl sm:p-6" x-show="open" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0 sm:scale-100" x-transition:leave-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" @click.away="open = false">
                        <div>
                            <div class="mt-3 text-center sm:mt-5">
                                ...
                                <div>
                                    <img src="{{asset('storage/Fiche.png')}}" style="width:800px; display:inline-block;"></td>
                                    <table class="min-w-full divide-y divide-gray-300">
                        ...
                        <div class="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                            <button @click="open=false" type="button" class="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:col-start-2 sm:text-sm">Retour</button>
